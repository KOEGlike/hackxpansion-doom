...
void P_InitPicAnims (void)
{
	...
	if (animdefs[i].istexture)
	{
		...
		continue;	
	    if (R_CheckTextureNumForName(endname) == -1)
		continue;   /* xpanse: skip partial animations */
	...
	else
	{
		...
		continue;
	    if (W_CheckNumForName(endname) == -1)
		continue;   /* xpanse: skip partial flat animations. */
