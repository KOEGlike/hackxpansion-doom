...
void I_FinishUpdate (void)
{
    ...
    /* xpanse: the Rust blit converts I_VideoBuffer directly; the
     * intermediate DG_ScreenBuffer copy is skipped. */
    (void)y_offset;
    (void)x_offset;
    (void)x_offset_end;
    (void)line_in;
...
/* xpanse: palette accessor for the Rust-side RGB565 blit. */
void I_GetPaletteRGB(byte *out)
{
    int i;
    for (i = 0; i < 256; ++i)
    {
        out[i * 3 + 0] = colors[i].r;
