...
void D_Display (void)
{
    ...
    /* xpanse: wipes are disabled to save zone memory for the console port. */
    wipe = false;
...
void D_DoomMain (void)
{
    ...
    // xpanse: the IWAD is embedded in flash; D_FindIWAD cannot run on the
    // console and there are no alternate WADs to discover.
    iwadfile = (char *) "doom1.wad";
    gamemission = doom;
